...
- Guard/Risk、完整 Trace、审批恢复、受限 Lab Executor、Rollback、Evidence Graph/BM25/RCA、三个固定恢复状态机、多轮文件、八视图 Web、六套 Benchmark、targetctl 和 release 安装/健康/数据保留卸载已取得目标证据；所有 Collector 适配器的目标执行尚未完成。
