...
const baseServers = {
  servers: [{
    ...
    discovery_history: [{ discovered_at: '2026-07-16T01:02:05Z', status: 'HEALTHY', server_name: 'safeops-mcp-system', server_version: '0.1.0', protocol_version: '2025-11-25', tool_set_hash: 'd'.repeat(64), tool_count: 1, tools_changed: false, dependencies_healthy: true, duration_millis: 1 }],
